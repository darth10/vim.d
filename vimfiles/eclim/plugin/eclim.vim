...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/darth10/.eclipse/org.eclipse.platform_4.2.0_155965261/plugins/org.eclim_2.2.1'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/darth10/.eclipse/org.eclipse.platform_4.2.0_155965261'
  if has('win32unix')
